    ...
    <div class="header-top">
        <div class="wrap-content">
            ...
            <div class="lang-header">
                <a
                    href="ngon-ngu/vi/"><?= $func->getImage(['size-error' => '35x25x1', 'upload' => 'assets/images/', 'image' => 'vi.jpg', 'alt' => 'Tiếng Việt']) ?></a>
                <a
                    href="ngon-ngu/en/"><?= $func->getImage(['size-error' => '35x25x1', 'upload' => 'assets/images/', 'image' => 'en.jpg', 'alt' => 'Tiếng Anh']) ?></a>
            </div>
    ...
    <div class="header-bottom">
        <div class="wrap-content">
            ...
            <a class="hotline-header">
                <p>Hotline hỗ trợ:</p>
                <span><?= $func->formatPhone2($optsetting['hotline']) ?></span>
            </a>
        </div>
    </div>
</div>