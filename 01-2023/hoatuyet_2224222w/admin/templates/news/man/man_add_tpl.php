            ...
            <?php if (isset($config['news'][$type]['file']) && $config['news'][$type]['file'] == true) { ?>
                            <div class="form-group">
                                <div class="upload-file mb-2">
                                    <p>Upload tập tin:</p>
                                    <label class="upload-file-label mb-2" for="file_tailieu">
                                        <div class="custom-file my-custom-file">
                                            <input type="file" class="custom-file-input" name="file_tailieu" id="file_tailieu" lang="vi">
                                            <label class="custom-file-label mb-0" data-browse="Chọn" for="file_tailieu">Chọn file</label>
                                        </div>
                                    </label>
                                    <?php if (isset($item['file_tailieu']) && $item['file_tailieu'] != '') { ?>
                                        <div class="file-uploaded mb-2">
                                            <a class="btn btn-sm bg-gradient-primary text-white d-inline-block align-middle rounded p-2" href="<?= UPLOAD_FILE . @$item['file_tailieu'] ?>" title="Download tập tin hiện tại"><i class="fas fa-download mr-2"></i>Download tập tin hiện tại</a>
                                        </div>
                                    <?php } ?>
