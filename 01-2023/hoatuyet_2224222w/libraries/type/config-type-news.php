...
/* Khóa học */
$nametype = "khoa-hoc";
$config['news'][$nametype]['title_main'] = "Khóa học";
$config['news'][$nametype]['check'] = array("noibat" => "Nổi bật", "hienthi" => "Hiển thị");
$config['news'][$nametype]['view'] = true;
$config['news'][$nametype]['slug'] = true;
$config['news'][$nametype]['copy'] = true;
...
$config['news'][$nametype]['thumb'] = '250x250x1';
$config['news'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
...
$config['news'][$nametype]['file_type'] = '.pdf|.png';

/* Giáo viên */
$nametype = "giao-vien";
$config['news'][$nametype]['title_main'] = "Giáo viên";
$config['news'][$nametype]['check'] = array("noibat" => "Nổi bật", "hienthi" => "Hiển thị");
$config['news'][$nametype]['view'] = true;
$config['news'][$nametype]['slug'] = true;
$config['news'][$nametype]['copy'] = true;
