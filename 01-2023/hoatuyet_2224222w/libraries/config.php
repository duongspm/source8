...
$config = array(
    ...
    'database' => array(
        'server-name' => $_SERVER["SERVER_NAME"],//01-2023\hoatuyet_2224222w
        'url' => '/source8/01-2023/hoatuyet_2224222w/',
        'type' => 'mysql',
        'host' => 'localhost',
        'username' => 'root',
        'dbname' => '2023-01_hoatuyet_2224222w',
        'password' => '',
        'port' => 3306,
        'prefix' => 'table_',
        'charset' => 'utf8mb4'
